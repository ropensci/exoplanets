...
This is a basic example which shows you how to access data from the exoplanet table. Note that all these examples have `progress` set to FALSE, the default is TRUE. I'm setting this parameter to FALSE to avoid a really long README file:
